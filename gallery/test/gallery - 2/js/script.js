        ...
        return `
            <div class="app-card normal">
                ...
                <div class="app-info">
                    ...
                    <div class="app-links">
                        <a href="${app.website}" class="app-website" target="_blank">官网</a>
                        <a href="${app.downloadLink}" class="download-link" target="_blank">下载</a>
                    </div>
                </div>
            </div>
        `;
...
function loadBanners() {
    const banners = [
        { image: 'images/banner1.jpg', title: 'Banner 1' },
        { image: 'images/banner2.jpg', title: 'Banner 2' },
        { image: 'images/banner3.jpg', title: 'Banner 3' },
    ];
